...
const Games: React.FC = () => {
  ...
  const games = [
    ...
    },
    {
      id: 'flashcards',
      title: 'Карточки',
      description: 'Классический режим с интервальным повторением (SM-2).',
      icon: '🃏',
      color: '#10b981',
      bg: 'rgba(16,185,129,0.12)',
      path: '/flashcards',
      tags: ['Повторение', 'SM-2'],
      minCards: 1,
    },
    {
      id: 'quiz',
      ...
      <div className="games-tips">
        ...
        <div className="tips-grid">
          {[
            ...
            ['🔄', 'Интервалы', 'Режим SM-2 автоматически напомнит повторить слово в нужный момент'],
